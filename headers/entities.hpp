...
void spawnDebris(GameContext &context, const Vector3 &position, const RenderBody *bodyPtr, float lifespan = 2.0f, Vector3 velocity = {0, 0, 0});
void spawnExplosion(GameContext &context, const Vector3& pos, float rad, Vector3 velocity = {0, 0, 0}, entt::entity parent = entt::null);
void spawnExplosion(GameContext &context, const Vector3& pos, float rad, Vector3 velocity = {0, 0, 0}, float lifespan = 5.0f, Color color = effect::EXPLOSION_COLOR, entt::entity parent = entt::null);
void spawnExplosion(GameContext &context, const Vector3& pos, const effect::ExplodeOnDeath &effect, Vector3 velocity = {0, 0, 0}, entt::entity parent = entt::null);
void spawnInstantDamage(GameContext &context, const Vector3& pos, const effect::InstantDamageOnDeath &effect, entt::entity parent = entt::null);
