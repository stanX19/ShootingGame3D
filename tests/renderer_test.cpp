...
int main()
{
    ...
    context.registry.emplace<RenderBody>(light, context.meshManager.createSphere(), 1.0f, WHITE); // Light color
    ...
    context.registry.emplace<RenderBody>(testModelEntity, context.meshManager.createSphere(), 1.0f, RED); // RenderBody for general rendering, not directly used by ModelData
